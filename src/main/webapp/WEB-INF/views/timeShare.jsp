...
<!--                   <th width="130">주소</th> -->
            ...
            <c:if test="${param.sort!='reg_date asc' and param.sort!='reg_date desc'}">
               <th width="130" style="cursor:pointer" onClick="searchWithSort('reg_date desc')">등록일</th>
            </c:if>
            
            <c:if test="${param.sort=='reg_date desc'}">
               <th  width="130" style="cursor:pointer" onClick="searchWithSort('reg_date asc')">등록일▼</th>
            </c:if>
            
            <c:if test="${param.sort=='reg_date asc'}">
               <th width="130" style="cursor:pointer" onClick="searchWithSort('')">등록일▲</th>
            </c:if>
